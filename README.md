...
.box{
  ...
  background-image: url(https://raw.githubusercontent.com/rodrigograca31/rodrigograca31/master/matrix.svg);
...
.box::before{
  ...
  margin: 5px;
  transition: 0s bottom, 0.2S left;
}
...
<div class="box">
    I'm Kumar Laxmikant <br> A passionate frontend developer from India
</div>
